...
d3.csv("weather.csv").then(data => {
    ...
    */
    const flattenedData1 = groupedData1.flatMap(({ city, values }) =>
    ...
    // // Check your work:
    console.log("Final flattened data:", flattenedData1);
    console.log("---------------------------------------------------------------------");
    ...
    */
    ...
    recordPrecip }) => [
        ...
        { month, precipitation: recordPrecip, new_category_prop: "Record" }
    ]);
    // Check your work:
